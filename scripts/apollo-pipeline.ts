...
const INDUSTRY_KEYWORDS: Record<string, string[]> = {
  ...
  restaurant: ["restaurant", "cafe", "bistro", "catering"],
  law: ["law firm", "legal services", "solicitors", "notary"],
  realestate: ["real estate", "property management", "letting agent", "estate agent"],
  salon: ["hair salon", "barbershop", "beauty salon", "nail salon"],
  dental: ["dental", "dentist", "orthodontist", "dental clinic"],
  fitness: ["gym", "fitness center", "crossfit", "yoga studio", "pilates"],
  auto: ["auto repair", "car service", "car dealership", "garage", "body shop"],
  education: ["school", "language school", "tutoring", "training center", "driving school"],
  wedding: ["wedding venue", "event venue", "event planning", "banquet hall"],
  tattoo: ["tattoo studio", "tattoo", "piercing studio"],
  spa: ["spa", "massage", "physiotherapy", "wellness center", "chiropractic"],
  vet: ["veterinary", "vet clinic", "animal hospital", "pet care"],
  accounting: ["accounting", "bookkeeper", "tax advisor", "accountant"],
  photography: ["photographer", "photo studio", "videographer", "wedding photography"],
  ecommerce: ["online shop", "e-commerce", "retail store", "boutique"],
  construction: ["contractor", "renovation", "construction company", "builder", "roofing"],
  cleaning: ["cleaning service", "janitorial", "maid service", "carpet cleaning"],
  carpenter: ["carpenter", "joinery", "woodworking", "furniture maker", "cabinet maker"],
  plumber: ["plumber", "plumbing", "heating engineer", "hvac"],
  electrician: ["electrician", "electrical contractor", "electrical services"],
  landscaping: ["landscaping", "garden design", "lawn care", "tree surgery"],
  moving: ["moving company", "removals", "relocation", "storage"],
  insurance: ["insurance broker", "insurance agency", "insurance advisor"],
  travel: ["travel agency", "tour operator", "travel consultant"],
  printing: ["printing", "print shop", "signage", "graphic design"],
  florist: ["florist", "flower shop", "floral design"],
  bakery: ["bakery", "patisserie", "confectionery", "cake shop"],
  pharmacy: ["pharmacy", "apothecary", "drugstore"],
  optician: ["optician", "optometrist", "eye care", "eyewear"],
  pet: ["pet shop", "pet grooming", "dog training", "kennel"],
  tailor: ["tailor", "alterations", "dressmaker", "bespoke clothing"],
  jewelry: ["jewelry", "jeweller", "watchmaker", "goldsmith"],
  music: ["music school", "music lessons", "recording studio", "instrument shop"],
  therapy: ["therapy", "counseling", "psychologist", "mental health"],
  coworking: ["coworking", "shared office", "serviced office", "business center"],
};
